...
function kindColor(kind) {
  return {
    task: ['var(--blue-bg)', 'var(--blue-fg)'], event: ['var(--purple-bg)', 'var(--purple-fg)'], waiting: ['var(--amber-bg)', 'var(--amber-fg)'],
    memory: ['var(--green-bg)', 'var(--green-fg)'], project: ['var(--blue-bg)', 'var(--blue-fg)'], openloop: ['var(--red-bg)', 'var(--red-fg)'],
    file: ['var(--purple-bg)', 'var(--purple-fg)'], voice: ['var(--red-bg)', 'var(--red-fg)'], image: ['var(--green-bg)', 'var(--green-fg)'], link: ['var(--blue-bg)', 'var(--blue-fg)']
